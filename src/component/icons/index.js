...
export const MoreIcon = ({ width = '1em', height = '1em', classNamePr }) => (
...
export const CartIcon = ({ width = '1em', height = '1em', className }) => (
    <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fas"
...
export const FlagVietNam = ({ width = '1em', height = '1em', className }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const FlagEngland = ({ width = '1em', height = '1em', className }) => (
    <svg width={width} height={height} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 30">
        <clipPath id="s">
...
export const Zalo = ({ width = '4em', height = '4em', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={width}
        height={height}
